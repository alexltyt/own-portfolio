  ...
  return (
    ...
    >
      ...
      <div className={`intro-line ${showLine0 ? 'showStay' : ''}`} id="line1">
        <span className="md:text-4xl  text-white max-w-lg text-3xl md:mb-5">
          Hey, I'm Alex,  
        </span>
      </div>
      ...
      <div className={`intro-line  ${showLine2 ? 'show' : ''} ${hideLine ? 'shrink-text' : ''}`} id="line2">
        <span className="text-white text-xs md:text-2xl">
          &nbsp; Taekwondo Coach &nbsp; | &nbsp; Student &nbsp; | &nbsp; Singer Song-writer &nbsp; |
        </span>
      </div>
      <div className={`intro-line  ${showLine3 ? 'show' : ''} ${hideLine ? 'shrink-text' : ''}`} id="line3">
        <span className="text-white text-lg md:text-2xl">
          with a primary focus on &nbsp; 
        </span>
      </div>
      <div className={`intro-line ${showLine4 ? 'showStay' : ''} my-10 md:my-14`} id="line4">
        <span className={`text-lg md:text-2xl  text-white max-w-lg md:max-w-2xl  ${showLine4 ? 'md:md-grow-text grow-text' : ''}`}>
          ...
          {/* <h2 className=" text-3xl md:text-6xl font-bold text-white max-w-lg md:max-w-2xl md:mb-5 ">
            Full Stack Developer
          </h2> */}
        ...
        <div className="hidden md:flex">
          <img
            src={ownImage}
            alt="my profile"
            className="rounded-2xl mx-auto w-1/3 md:w-6/12 2xl:-ml-10"
          />
        </div>
      </div>
    </div>
